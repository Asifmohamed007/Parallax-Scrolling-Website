...
<div align="center">
  ...
  <h2 align="center">Parallax-Scrolling-Website</h2>

  Parallax-Scrolling-Website is a fully responsive website, <br />Responsive for all devices, build using HTML, CSS, and JavaScript.

  <a href="https://parallax-scr.netlify.app"><strong>➥ Live Demo</strong></a>
...
To run **Parallax-Scrolling-Website** locally, run this command on your git bash:

Linux and macOS:

```bash
sudo git clone https://github.com/Parallax-Scrolling-Website.git
```

Windows:

```bash
git clone https://github.com/Asifmohamed007/Parallax-Scrolling-Website.git
```
